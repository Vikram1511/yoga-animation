...
public:
    ...
    void CalibrateSkeleton() {
        ...
        // cout << "inside caliberate skeleton " <<"joint size = " << JOINT_SIZE<< endl ; 
        // cout<<"here" << endl ;
        ...
        // cout<<"before creating vector" << endl ; 
        ...
        // cout << " caliberate skeleton complete" << endl ;
    }
    ...
    void SaveToBVHFile(const string& filename) {
       cout << "check here" <<filename.c_str() << endl ;
